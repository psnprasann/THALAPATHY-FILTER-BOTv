...
SHORTLINK_API = environ.get('SHORTLINK_API', 'a3008bca9182015b806dac8023c28b5311362178')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001981876236'))
...
if HAS_SSL:
    URL = "https://adlinkfly-telegram-bot-z0zo.onrender.com/".format(FQDN)
else:
    URL = "https://adlinkfly-telegram-bot-z0zo.onrender.com/".format(FQDN)
